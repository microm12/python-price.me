    ...
    def send(self):
        return requests.post(
            ...
            data={
                ...
                "to": self.user_email,
                "subject": "{} Just got in your price range!".format(self.item.name),
                "text": "Here it is ! -> {} . To navigate to the alert that is responsible for this message please visit {}".format(self.item.url, "http://priceme.margelou.com/alerts/{}".format(self._id))
            }
        )
